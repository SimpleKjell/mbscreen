...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      {{Form::text('video_url', $kampagne->video_url, ['class' => 'form-control', 'placeholder' => 'Videourl'])}}
    </div>
    <div class="col-md-2">
      {{Form::label('video_duration', 'Videolänge')}}
      {{Form::text('video_duration', $kampagne->video_duration, ['class' => 'form-control', 'placeholder' => 'Videourl'])}}
    </div>
  </div>
